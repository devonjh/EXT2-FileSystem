...
int init()
{
  /* WRITE C code to initialize
   ...
   (2).proc[0]'s pid=1, uid=0, cwd=0, fd[ ]=0; super user 
       proc[1]'s pid=2, uid=1, cwd=0, fd[ ]=0; not super user
       */
  int i = 0;
